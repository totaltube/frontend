...
func getChannelsListFunc(hostName string, langId string, defaultAmount int64) func(args ...interface{}) *types.ChannelResults {
	return func(args ...interface{}) *types.ChannelResults {
		...
		results, _, err := api.ChannelsList(hostName, langId, page, sortBy, amount)
		if err != nil {
